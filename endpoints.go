	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		endpoints := []Endpoint{
			...
			{"APB: Books of the Bible",
				...
				nil},
			{"BOM: Total records",
				baseurl + "/bom/totalbills",
				nil},
			{"BOM: Parishes",
				baseurl + "/bom/parishes",
				nil},
			{"BOM: Bills of Mortality",
				baseurl + "/bom/bills?start-year=1648&end-year=1754&bill-type=All&count-type=All&limit=50&offset=0",
				[]ExampleURL{
					{baseurl + "/bom/bills?start-year=1648&end-year=1754&bill-type=Weekly&parishes=1,3,17,28&limit=50&offset=0",
						"Weekly bills for a specific parish or set of parishes by ID. Bill type can be: Weekly or General."},
					{baseurl + "/bom/bills?start-year=1648&end-year=1754&count-type=Buried&limit=50&offset=0",
						"Bills data for a specific count type (Buried or Plague). Specific parishes can be provided."},
					{baseurl + "/bom/bills?start-year=1648&end-year=1754&bill-type=Weekly&count-type=Buried&limit=50&offset=0",
			...
			{"BOM: General Bills of Mortality",
				baseurl + "/bom/generalbills?start-year=1669&end-year=1754",
				nil},
			{"BOM: Causes of Death",
				baseurl + "/bom/causes",
				nil},
			{"BOM: Christenings",
				baseurl + "/bom/christenings?start-year=1669&end-year=1754",
				nil},
